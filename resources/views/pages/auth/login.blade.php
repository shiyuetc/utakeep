...
<div class="flex justify-center py-8">
    <div class="w-full max-w-md bg-white border border-gray-200 shadow-md p-8">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <button type="submit" class="w-full h-9 mt-2 bg-primary text-primary-light text-sm font-medium hover:bg-primary-hover transition cursor-pointer">ログイン</button>
        </form>
